...
public abstract class IAddressTask {
	...
	private JSONObject doWifi() throws Exception {
		...
		if(wifiManager.getConnectionInfo().getBSSID() == null) {
			throw new RuntimeException("wifi bssid is null");
		}
		*/
	...
	public static class MLocation {
		...
		public String toString() {
			...
			*/
			...
			buffer.append(AppZkxc.TOKEN_WIFI + "," + Latitude + "," + Longitude);
			Debug.Log("WIFI定位：" + buffer.toString());
